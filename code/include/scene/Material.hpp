...
#define Types                                                                                                        \
    Wrapper::IntType, Wrapper::FloatType, Wrapper::RGBType, Wrapper::RGBAType, Wrapper::Vec3Type, Wrapper::Vec4Type, \
        Wrapper::TextureIdType
...
#undef Types
    ...
    struct Material
    {
      ...
      public:
        ...
        {
            auto it = find_if(
                properties.begin(), properties.end(), [&key](const Property& p1) -> bool { return p1.key == key; });
        ...
        bool registerProperty(const string& key, T value)
        {
            ...
            if (!fail) { properties.push_back(Property{key, value}); }
            return !fail;
        }
        ...
        bool registerProperty(const Property& prop)
        {
            ...
            if (!fail) { properties.push_back(prop); }
            return !fail;
        }
        ...
        {
            if (i < properties.size()) { properties.erase(properties.begin() + i); }
        }
    };
