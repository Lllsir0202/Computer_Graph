...
//  2019-08-01: DirectX11: Fixed code querying the Geometry Shader state (would generally error with Debug layer
...
bool ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        if (g_pd3dDevice->CreateVertexShader(
                vertexShaderBlob->GetBufferPointer(), vertexShaderBlob->GetBufferSize(), NULL, &g_pVertexShader) !=
            S_OK)
        {
    ...
    // Create the pixel shader
    {
        ...
        if (g_pd3dDevice->CreatePixelShader(
                pixelShaderBlob->GetBufferPointer(), pixelShaderBlob->GetBufferSize(), NULL, &g_pPixelShader) != S_OK)
        {
