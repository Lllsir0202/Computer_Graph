        ...
        while (getline(file, currLine))
        {
            ...
            else if (token == "f")
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    else { vertexStream >> v >> c >> t >> c >> n; }

                    if (v != -1)
                    {
                        // 找到
                        auto finded = pMap->find(v);
                        if (finded != pMap->end()) { vpi[i] = finded->second; }
                        else
                        {
                    ...
                    if (t != -1)
                    {
                        ...
                        if (finded != tMap->end()) { vti[i] = finded->second; }
                        else
                        {
                    ...
                    if (n != -1)
                    {
                        ...
                        if (finded != nMap->end()) { vni[i] = finded->second; }
                        else
                        {
